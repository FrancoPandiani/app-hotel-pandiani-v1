...
namespace Hotel_Pandiani.Migrations
{
    ...
    [Migration("20220119212211_cambiosbasicos")]
    partial class cambiosbasicos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Asistencia", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Empleado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Habitacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Telefono", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Asistencia", b =>
                {
                    b.HasOne("Hotel_Pandiani.Models.Empleado", "Empleado")
            ...
            modelBuilder.Entity("Hotel_Pandiani.Models.Habitacion", b =>
                {
                    b.HasOne("Hotel_Pandiani.Models.Empleado", "EmpleadoAcargo")
